...
namespace JuicyChickenGames
{
    ...
    {
        // Shared instance so repeated Shuffle/Sample calls in the same frame don't
        // reseed from the same clock tick and produce identical orderings.
        ...
        {
            return enumerable.OrderBy(x => rng.Next()).Take(1).FirstOrDefault();
        }
        ...
        public static IEnumerable<T> Sample<T>(this IEnumerable<T> enumerable, int pick)
        {
            ...
            return enumerable.OrderBy(x => rng.Next()).Take(pick);
        }

        public static IEnumerable<T> Shuffle<T>(this IEnumerable<T> enumerable)
        {
            return enumerable.OrderBy(x => rng.Next());
        }
